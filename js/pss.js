...
function computerThrows(CPUThrow) {
    switch (CPUThrow) {
        case throws.ROCK:
            ...
            document.getElementById("ComputerThrow").src = "../img/Rock.png";
            break;
        case throws.PAPER:
            document.getElementById("ComputerThrow").style.display = "inline";
            document.getElementById("ComputerThrow").src = "../img/Paper.png";
            break;
        case throws.SCISSORS:
            document.getElementById("ComputerThrow").style.display = "inline";
            document.getElementById("ComputerThrow").src = "../img/Scissors.png";
            break;
    }
}
